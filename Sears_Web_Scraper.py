# -*- coding: utf-8 -*-
"""
Created on Mon Dec 14 09:58:04 2015
...
def LoadHTML():
    init_url="http://local.sears.com/Schaumburg-IL-60173/#!/weeklyad/"
...
def CircularScrape(circ_id,storeId=10153,unitNumber=1570):
    circ_url="http://local.sears.com/getPages?storeId={1}&unitNumber={2}&actId={0}".format(circ_id,storeId,unitNumber)
...
def main():
    ...
    for circInfo in circ_list:
        ...
        with open("Sears-"+str(circInfo[0])+".csv","wb") as output_file:
